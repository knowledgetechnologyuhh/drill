...
logger = logging.getLogger('SEQ-Log')
...
class Sequential:
    ...
    def training(self, train_datasets, **kwargs):
        ...
        for epoch in range(epochs):
            ...
            for train_id, train_dataset in enumerate(train_datasets):
                logger.info('Training on {}'.format(train_dataset.__class__.__name__))
                train_dataloader = data.DataLoader(train_dataset, batch_size=kwargs.get('batch_size'), shuffle=False)
