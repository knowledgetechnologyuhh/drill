...
class ANML:
    def __init__(self, device, n_classes, fusion="gbu", **kwargs):
        ...
        self.nm = BertNM(device=device)
        self.pn = BertPN(n_classes=n_classes, max_length=kwargs.get('max_length'), device=device)
